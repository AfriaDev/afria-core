...
describe('AfriaFactory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as AfriaFactory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('AfriaPool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('AfriaPool')
