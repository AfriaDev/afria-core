...
describe('AfriaPool', () => {
  ...
  let pool0: MockTimeAfriaPool
  let pool1: MockTimeAfriaPool
  ...
  let swapTargetCallee: TestAfriaCallee
  let swapTargetRouter: TestAfriaRouter
