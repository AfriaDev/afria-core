...
interface AfriaPoolDerivedStateInterface extends ethers.utils.Interface {
  functions: {
...
export class AfriaPoolDerivedState extends Contract {
  ...
  interface: AfriaPoolDerivedStateInterface;
