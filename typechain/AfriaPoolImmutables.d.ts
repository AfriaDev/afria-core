...
interface AfriaPoolImmutablesInterface extends ethers.utils.Interface {
  functions: {
...
export class AfriaPoolImmutables extends Contract {
  ...
  interface: AfriaPoolImmutablesInterface;
