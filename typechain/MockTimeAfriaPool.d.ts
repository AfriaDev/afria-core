...
interface MockTimeAfriaPoolInterface extends ethers.utils.Interface {
  functions: {
...
export class MockTimeAfriaPool extends Contract {
  ...
  interface: MockTimeAfriaPoolInterface;
