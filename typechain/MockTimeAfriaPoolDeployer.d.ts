...
interface MockTimeAfriaPoolDeployerInterface extends ethers.utils.Interface {
  functions: {
...
export class MockTimeAfriaPoolDeployer extends Contract {
  ...
  interface: MockTimeAfriaPoolDeployerInterface;
