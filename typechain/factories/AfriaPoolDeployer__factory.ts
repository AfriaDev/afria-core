...
import type { AfriaPoolDeployer } from "../AfriaPoolDeployer";

export class AfriaPoolDeployer__factory extends ContractFactory {
  constructor(signer?: Signer) {
    super(_abi, _bytecode, signer);
  }

  deploy(overrides?: Overrides): Promise<AfriaPoolDeployer> {
    return super.deploy(overrides || {}) as Promise<AfriaPoolDeployer>;
  }
  getDeployTransaction(overrides?: Overrides): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): AfriaPoolDeployer {
    return super.attach(address) as AfriaPoolDeployer;
  }
  connect(signer: Signer): AfriaPoolDeployer__factory {
    return super.connect(signer) as AfriaPoolDeployer__factory;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AfriaPoolDeployer {
    return new Contract(address, _abi, signerOrProvider) as AfriaPoolDeployer;
  }
}
