...
interface AfriaPoolOwnerActionsInterface extends ethers.utils.Interface {
  functions: {
...
export class AfriaPoolOwnerActions extends Contract {
  ...
  interface: AfriaPoolOwnerActionsInterface;
